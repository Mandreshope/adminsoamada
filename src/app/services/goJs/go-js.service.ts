...
export class GoJsService {
  ...
  init() {
    ...
    var nodeDataArray = [
      ...
      { key: 5, text: "d", length: 6.33, earlyStart: 4, lateFinish: 34.01, critical: false },
      { key: 6, text: "e", length: 5.17, earlyStart: 9.17, lateFinish: 14.34, critical: true },
      { key: 7, text: "f", length: 4.5, earlyStart: 1, lateFinish: 19.51, critical: true },
      { key: 8, text: "g", length: 5.17, earlyStart: 14.34, lateFinish: 19.51, critical: true },
      { key: 9, text: "Finish", length: 0, earlyStart: 1, lateFinish: 19.51, critical: true }
    ];
    var linkDataArray = [
      { from: 1, to: 2 },
      { from: 1, to: 3 },
